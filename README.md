...
<p align="center">
  <picture>
    ...
    <img src="./assets/readme/hero-light.svg" width="100%" alt="Piyal Dey, AI Engineer in Aalborg, Denmark. Designing and shipping AI applications end to end: agents, retrieval, APIs, front ends and the infrastructure they run on. Python, TypeScript, Azure, Hetzner, Kubernetes.">
  </picture>
</p>
...
I'm an AI Engineer at [Plant Supervision](https://plant-supervision.com/) in Aalborg, Denmark, where I design and ship AI applications end to end: LLM and agent workflows, retrieval pipelines, the FastAPI services behind them, React front ends, and the cloud infrastructure they run on.

I hold an MSc in Business Data Science from Aalborg University. My thesis examined gender bias in LLM-based resume screening and how embedding strategy, prompt design and calibration affect it. I'm also a Microsoft Certified Azure Data Scientist Associate (DP-100).
...
Multi-agent evaluation of resumes against a job description, with retrieval-backed Q&A so recruiters can ask follow-up questions about any candidate. Deployed on Azure with persistent state across releases. An open-source version is on GitHub: [PD-BDS/HireX](https://github.com/PD-BDS/HireX).<br>
`CrewAI` `LangChain` `ChromaDB` `FastAPI` `React` `TypeScript` `Azure`

**Assessk** · AI-assisted machinery risk assessment<br>
A form-driven web application that guides engineers through a structured risk assessment for industrial machinery and drafts the documentation with LLM support.<br>
`FastAPI` `Next.js` `TypeScript` `LLM`

**Contractbook** · internal contract-lifecycle tool<br>
Contract drafting, electronic signature and a tamper-evident audit trail in one application.<br>
`TypeScript` `Next.js`
...
<p align="center">
  <picture>
    ...
    <img src="./assets/readme/languages-by-repo-light.svg" width="49%" alt="Top languages by repository size: Python first, then TypeScript, then others">
  </picture>
  <picture>
    ...
    <img src="./assets/readme/languages-by-commit-light.svg" width="49%" alt="Top languages by commits over the last year: Python first, then TypeScript, then others">
  </picture>
</p>
